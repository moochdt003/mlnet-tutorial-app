...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/Users/moochdt003/source/POC/mlnet-tutorial-app/taxi-fare-regression/taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=33,NumberOfTrees=186,MaximumBinCountPerFeature=221,FeatureFraction=0.7440999164695684,LearningRate=0.7637639221408457,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",DiskTranspose=false}));
